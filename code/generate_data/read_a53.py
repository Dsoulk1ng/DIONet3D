...
class Paraser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--data_root',     default='./original/a53/', help='data to be processed from EDA tools')
        
        self.parser.add_argument('--lef_path',      default='./original/tech1_lef/', help='path to tech1 LEF files')

        self.parser.add_argument('--def_path',      default='./original/a53/def/', help='path to DEF files')
        self.parser.add_argument('--rpt_path',      default='./original/a53/pwr_rpt/', help='path to power rpt files')
        self.parser.add_argument('--bumpfile_path', default='./original/a53/bumpfile/', help='path to bump locations files')
        self.parser.add_argument('--iv_path',       default='./original/a53/iv/', help='path to instance voltage files')
