...
class Paraser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--data_root',     default='./original/a53x2/', help='data to be processed from EDA tools')
        
        self.parser.add_argument('--lef_path',      default='./original/tech1_lef/', help='path to tech1 LEF files')

        self.parser.add_argument('--def_path',      default='./original/a53x2/def/', help='path to DEF files')
        self.parser.add_argument('--rpt_path',      default='./original/a53x2/pwr_rpt/', help='path to power rpt files')
        self.parser.add_argument('--bumpfile_path', default='./original/a53x2/bumpfile/', help='path to bump locations files')
        self.parser.add_argument('--iv_path',       default='./original/a53x2/iv/', help='path to instance voltage files')
        
        self.parser.add_argument('--save_path',     default='./processed/training_set', help='processed data input into the network')

        self.parser.add_argument('--unit', default=2000, help='set 2000 when design is a53 and a53x2')
