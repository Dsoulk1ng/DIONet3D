...
class Paraser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--data_root',     default='./original/nxsoc/', help='data to be processed from EDA tools')
        
        self.parser.add_argument('--lef_path',      default='./original/tech2_lef/', help='path to LEF files')

        self.parser.add_argument('--def_path',      default='./original/nxsoc/def/', help='path to DEF files')
        self.parser.add_argument('--rpt_path',      default='./original/nxsoc/pwr_rpt/', help='path to power rpt files')
        self.parser.add_argument('--bumpfile_path', default='./original/nxsoc/bumpfile/', help='path to bump locations files')
        self.parser.add_argument('--iv_path',       default='./original/nxsoc/iv/', help='path to instance voltage files')
        
        self.parser.add_argument('--save_path',     default='./processed/training_set', help='processed data input into the network')

        self.parser.add_argument('--unit', default=1000, help='set 1000 when design is NXSoC')
...
class ReadInnovusOutput:
    ...
    def apply_tsv_mask(self):
        ...
        pattern = re.compile(r"rdl|t8m3", re.IGNORECASE) 
